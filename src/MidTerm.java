...
public class MidTerm {
	...
	public static void main(String[] args) {
		System.out.println(
				"Once upon a time in the mystical land of Detroit there dwelt an immortal named David and his trusty band of ninja monkeys.");
		...
		System.out.println("One-by-one every last pesky bug fell at the quick hands of the monkeys.");
	}
